...
public class Demo3_1catchErrorCode {
	...
	// 新增資料的方法
	public void newdeta() throws SQLException {
		String sql = "insert into product('productname','productprice','remark') values('javascript','168168','pack')";
		Statement state = conn.createStatement();
		int row = state.executeUpdate(sql);
	...
	public static void main(String[] args) {
		Demo3_1catchErrorCode demo3 = new Demo3_1catchErrorCode();
